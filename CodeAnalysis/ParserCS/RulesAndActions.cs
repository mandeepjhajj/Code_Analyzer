...
namespace ParserCS
{
    ...
    {
            Repository repo_, rp1;

            
            public SearchInherit(Repository repo, Repository rp)
            {
                repo_ = repo;
                rp1 = rp;
            }
            public override void doAction(SemiEx.CSemiExp semi, string file)
            {
                ...
                List<Elem> nm = repo_.stack.getList();
                List<Elem> loc = repo_.locations;
                RepositoryPermanemt pr = new RepositoryPermanemt();
                List<Elements> perm = pr.returnPermanentRep();
    ...
    public class SearchAggregation : AAction
    {
        ...
        public SearchAggregation(Repository repo, Repository rp)
        {
            repo_ = repo;
            rp1 = rp;
        }
    ...
    public class SearchComposition : AAction
    {
        ...
        public SearchComposition(Repository repo, Repository rp)
        {
            repo_ = repo;
            rp1 = rp;
        }
    ...
    public class SearchUsing : AAction
    {
        ...
        public SearchUsing(Repository repo, Repository rp)
        {
            repo_ = repo;
            rp1 = rp;
        }
    ...
    {
        Repository repo;
        Repository rp1 = new Repository();   

        public RelationshipAnalyzer(SemiEx.CSemiExp semi)
        {
            repo = Repository.getInstance();   //It might give only the last file of pass 1 instance
            rp1.semi = semi;
        }
